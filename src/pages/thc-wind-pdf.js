...
import WindPDF from "../assets/SpecSheet_THCWindwPrinter.pdf"

class ThcWindPDF extends Component {
  state = {
    numPages: null,
    pageNumber: 1,
  }
  ...
  render() {
    ...
    return (
      ...
      >
        <PageTransition>
          <Document file={WindPDF} onLoadSuccess={this.onDocumentLoadSuccess}>
